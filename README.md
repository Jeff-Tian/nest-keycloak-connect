...
[![Build Status](https://travis-ci.com/Jeff-Tian/nest-keycloak-connect.svg?branch=master)](https://travis-ci.com/Jeff-Tian/nest-keycloak-connect)
...
```bash
yarn add @jeff-tian/nest-keycloak-connect
```

### NPM

```bash
npm install @jeff-tian/nest-keycloak-connect --save
```
